...
\begin{figure*}[h]
  \vspace{-0.3cm}
  \newcommand{\kmeans}{\includegraphics[scale=0.40]{graphics/ch-spectra_image_clustering/sp_image_clustering-fig2a.png}}
  \newcommand{\hyperspectra}{\includegraphics[scale=0.25]{graphics/ch-spectra_image_clustering/sp_image_clustering-fig2b.png}}
  \noindent\makebox[\textwidth]{\kmeans \hspace{-0.5cm} \hyperspectra}
  \vspace{-1.0cm}
...
\begin{figure*}[h]
  \vspace{-0.3cm}
  \newcommand{\hyperspectra}{\includegraphics[scale=0.25]{graphics/ch-spectra_image_clustering/sp_image_clustering-fig4b.png}}
  \newcommand{\selectrows}{\includegraphics[scale=0.45]{graphics/ch-spectra_image_clustering/sp_image_clustering-fig4a.png}}
  \noindent\makebox[\textwidth]{\selectrows \hspace{-0.5cm} \hyperspectra}
  \vspace{-1.cm}
  \caption{The \widget{Spectra} widget shows wrong predictions for the DNA class.}
