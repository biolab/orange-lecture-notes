...
\begin{figure*}[h]
    \centering
    \newcommand{\clustering}{\includegraphics[scale=0.4]{graphics/ch-hierarchical_clustering/hierarchical_clustering.png}}
    \newcommand{\plot}{\includegraphics[scale=0.4]{graphics/ch-hierarchical_clustering/scatterplot_clustered.png}}
    \infinitewidthbox{
