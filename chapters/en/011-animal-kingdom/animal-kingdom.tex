...
\begin{wrapfigure}{o}{0.8\textwidth}
    ...
    \caption{\textbf{\textsf{Hierarchical clustering works fast for smaller data sets. But for bigger ones it fails. Simply, it cannot be used. Why?}}}
\end{wrapfigure}
...
\begin{figure*}[h]
    ...
    \caption{\textbf{\textsf{What is wrong with those mammals? Why can't they be in one single cluster? Two reasons. First, they represent 40\% of the data instances. Second, they include some weirdos. Who are they?}}}
\end{figure*}
