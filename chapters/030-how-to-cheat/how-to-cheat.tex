...
\begin{figure*}[h]
    \infinitewidthbox{
    \includegraphics[scale=0.3]{scatterplot_iris.png}
    \includegraphics[scale=0.4]{randomize100.png}
    \includegraphics[scale=0.3]{scatterplot_iris_random.png}
    }
...
\begin{wrapfigure}{o}{0.85\textwidth}
    \includegraphics[scale=0.35]{tree_viewer.png}
...
\begin{figure}[h]
    \includegraphics[scale=0.35]{confusion_sampler.png}
