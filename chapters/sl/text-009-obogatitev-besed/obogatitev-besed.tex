...
Sedaj o modelu vemo že veliko, ampak kaj ne bi bilo super pogledati, za katere pravljice se je model zmotil in za katere je imel prav? Gradnik \textit{Confusion Matrix} omogoča prav to!
...
Da preverimo napačno klasificirane dokumente, lahko uporabimo \textit{Corpus Viewer}. Ali pa še bolje, pogledamo, katere besede so značilne za katero podmnožico!
