...
Prenesite slo-geo-tweets.tab z \url{http://file.biolab.si/text/slo-geo-tweets.tab} in poglejte podatke v gradniku \widget{Corpus Viewer}.
...
Seveda ne bomo naredili tega! Do sedaj že vemo, da obstajajo hitrejši načini raziskovanja podatkov. Lahko jih na primer prikažemo na zemljevidu. Povežite Corpus z \widget{Geo Map} - gradnik bo avtomatsko našel stolpca latitude in longitude in prikazal podatke.
