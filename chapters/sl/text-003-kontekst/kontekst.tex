...
Sedaj smo pripravili korpus in čas je, da ga prikažemo. En način prikaza je oblak besed, ki ga že poznamo. \widget{Word Cloud} nam prikaže pogostost besed. Pogostejša kot je beseda, z večjimi črkami bo zapisana.\marginnote{Vizualizacije v Orangeu so narejene tako, da podpirajo izbor podmnožic. Odkrivanje zanimivih podmnožic in raziskovanje njihovih podobnosti je ključni del odkrivanja znanj iz podatkov.}
...
Da bi preverili kontekst posamezne besede, lahko uporabimo gradnik Concordance. \widget{Concordance} pokaže besedilo okrog izbrane besede.
Povežite Concordance z gradnikom \widget{Corpus}. Tako Concordance dobi vhodno besedilo. Besedo lahko poiščemo z iskalnikom na vrhu gradnika ali pa jo izberemo v gradniku \widget{Word Cloud}.
