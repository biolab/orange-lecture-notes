...
Poglejmo si preproste podatke z dvema stolpcema (glejte opombo) in jih prikažimo v gradniku \widget{Scatter Plot}. Koliko skupin imamo? Kaj predstavlja različne skupine? Kateri primeri sodijo v posamezno skupino?
...
Naložite podatke z gradnikom \widget{Datasets}, izračunajte razdalje z gradnikom \widget{Distances}, uporabite \widget{Hierarchical Clustering} in si poglejte rezultate v gradniku \widget{Scatter Plot}. Gradnik Hierarchical Clustering omogoča, da hierarhijo skupin odrežemo pri določeni meri podobnosti in tako definiramo skupine.
